...
import products from '../../components/Data/Products'; import Filter from '../../components/Filter/Filter'; // Import the Filter component
...
<DefaultLayout>
      <div className="alleasylist-layout">
        ...
        <div className="alleasylist-product-section">
          <h1 className="alleasylist-title">Lips Products</h1>
